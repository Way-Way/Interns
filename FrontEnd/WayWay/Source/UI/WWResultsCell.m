...
- (void) update:(WWPlace*)place hashtag:(NSString*)hashtag displayLabel:(BOOL)displayLabel
{
    ...
    NSDictionary* baseAttrs = @{NSFontAttributeName : WW_FONT_H5, NSForegroundColorAttributeName : WW_GRAY_COLOR_11 };
    ...
    UIImage* defaultImg = [UIImage wwSolidColorImage:WW_GRAY_COLOR_11];
