...
@implementation UIImage (WWFramework)
                   ...
                   borderWidth:(CGFloat)borderWidth
{
    ...
    UIImage* image = [self viewToImage:view];
    ...
    path.flatness = 10;
    [path addClip];
    //CGPathRef path = [self allocRoundedRectPath:rect radius:cornerRadius];
