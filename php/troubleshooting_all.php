...
$lat = isset($_GET['lat']) ? $_GET['lat'] : 48.853887;
$long = isset($_GET['long']) ? $_GET['long'] : 2.334445;
$meters = isset($_GET['meters']) ? $_GET['meters'] : 1000.0;
...
$sqlgetPlaces = "select distinct d.place_id_1, p.place_id, p.sourcename, p.source_id, p.name, p.address, p.city, m.value, des.phone, des.website
from distances as d,
metrics as m,
